...
export class LicenseManager {
    ...
    static async clearAssignment(idSystemObject: number, clearAll?: boolean | undefined): Promise<boolean> {
        ...
        CACHE.LicenseCache.clearAssignment(idSystemObject);             // don't await ... allow this to happen asynchronously
        return retValue;
    }
    ...
    static async setAssignment(idSystemObject: number, license: License, idUserCreator?: number | null | undefined,
        ...
        CACHE.LicenseCache.setAssignment(idSystemObject, new LicenseResolver(license, assignment, false));  // don't await ... allow this to happen asynchronously
        return retValue;
    }
}
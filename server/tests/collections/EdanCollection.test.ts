...
export async function scrapeDPOMigrationMDM(ICol: COL.ICollection, fileName: string): Promise<void> {
    ...
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200004', '129');
    ...
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200011', '74');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200011', '75');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200011', '76');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200011', '77');
    ...
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200021', '157');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200023', '158');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200023', '159');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200026', '154');
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200026', '155');
    ...
    await handleResults(ICol, WS, 'edanmdm:dpo_3d_200035', '170');
    ...
    await handleResults(ICol, WS, 'edanmdm:fsg_F1986.21a-c', '331');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1986.4a-b', '349');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1989.1', '313');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1989.1', '314');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '342');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '343');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '344');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '345');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '346');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '347');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.46', '348');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.48a-b', '111');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.49', '317');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.49', '318');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.49', '319');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.49', '320');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1991.49', '321');
    ...
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.14a-b', '338');
    ...
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.34.1', '325');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.47.1', '308');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.47.1', '309');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.47.3a-b', '332');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.47.3a-b', '333');
    await handleResults(ICol, WS, 'edanmdm:fsg_F1992.47.3a-b', '334');
    ...
    await handleResults(ICol, WS, 'edanmdm:nasm_A19700102000', '7');
    ...
    await handleResults(ICol, WS, 'edanmdm:nasm_A19791810000', '30');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmaahc_2013.57', '922');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmafa_74-20-1', '409');
    await handleResults(ICol, WS, 'edanmdm:nmafa_74-20-1', '410');
    await handleResults(ICol, WS, 'edanmdm:nmafa_74-20-2', '411');
    await handleResults(ICol, WS, 'edanmdm:nmafa_74-20-2', '412');
    await handleResults(ICol, WS, 'edanmdm:nmafa_74-20-2', '413');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmah_363781', '915');
    await handleResults(ICol, WS, 'edanmdm:nmah_363781', '916');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmah_705564', '886');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmah_763853', '483');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhanthropology_8114628', '616');
    await handleResults(ICol, WS, 'edanmdm:nmnhanthropology_8114628', '617');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnheducation_11380180', '795');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnheducation_15006160', '891');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_10703', '476');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_11162', '482');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_17174', '509');
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_17182', '247');
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_17182', '511');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_17355', '515');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_17599', '521');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_31148', '536');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_44873', '678');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_45849', '544');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhinvertebratezoology_48461', '548');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_10250729', '191');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_10369553', '67');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_10369553', '68');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_10369553', '69');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_10611715', '216');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_10611715', '856');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_12307093', '774');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_12307204', '755');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_12307233', '858');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_12307240', '23');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_12307240', '214');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3176889', '844');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3188192', '848');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3188200', '751');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3188200', '849');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3341954', '839');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3377843', '867');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3397958', '831');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3415628', '748');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3415628', '837');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3427971', '274');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3428388', '153');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3440721', '829');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3446197', '84');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3446197', '85');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3449928', '842');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3450090', '79');
    await handleResults(ICol, WS, 'edanmdm:nmnhpaleobiology_3450090', '869');
    ...
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4091696', '799');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4091696', '800');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4092671', '658');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4092671', '659');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4092671', '660');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4103596', '622');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4103596', '623');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4103596', '624');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4103600', '628');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4103600', '629');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4103600', '630');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4105734', '807');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4105734', '808');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4105734', '809');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113049', '701');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113049', '702');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113049', '703');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113270', '768');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113270', '769');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113270', '770');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113913', '810');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113913', '811');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4113913', '812');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4114243', '625');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4114243', '626');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4114243', '627');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4114544', '611');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4114544', '612');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4114544', '613');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4115950', '818');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4115950', '819');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4115950', '820');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4119824', '801');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4119824', '802');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4119824', '803');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4123288', '637');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4123288', '638');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4123288', '639');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4123616', '696');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4123616', '697');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4123616', '698');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4125718', '619');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4125718', '620');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4125718', '621');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4175860', '778');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4175860', '779');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4175860', '780');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4278661', '771');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4278661', '772');
    await handleResults(ICol, WS, 'edanmdm:nmnhvz_4278661', '773');
    ...
    await handleResults(ICol, WS, 'edanmdm:npg_NPG.71.24', '88');
    await handleResults(ICol, WS, 'edanmdm:npg_NPG.71.26', '42');
    await handleResults(ICol, WS, 'edanmdm:npg_NPG.71.26', '89');
    ...
    await handleResults(ICol, WS, 'helmet type m1917 ', '371');

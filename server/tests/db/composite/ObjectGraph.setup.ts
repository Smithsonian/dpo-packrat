...
export class ObjectGraphTestSetup {
    ...
    async initialize(): Promise<void> {
        ...
        this.assetVersionT1 = await UTIL.createAssetVersionTest({ idAsset: this.assetT1.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersionT1', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersionT2 = await UTIL.createAssetVersionTest({ idAsset: this.assetT2.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersionT2', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        this.item1 = await UTIL.createItemTest({ idAssetThumbnail: this.assetT2.idAsset, idGeoLocation: null, Name: 'OA Test item1', EntireSubject: true, idItem: 0 });
        assigned = await this.assetT2.assignOwner(this.item1); expect(assigned).toBeTruthy();
        this.item2 = await UTIL.createItemTest({ idAssetThumbnail: null, idGeoLocation: null, Name: 'OA Test item2', EntireSubject: true, idItem: 0 });
        this.item3 = await UTIL.createItemTest({ idAssetThumbnail: null, idGeoLocation: null, Name: 'OA Test item3', EntireSubject: true, idItem: 0 });
        this.item4 = await UTIL.createItemTest({ idAssetThumbnail: null, idGeoLocation: null, Name: 'OA Test item4', EntireSubject: true, idItem: 0 });
        ...
        this.assetVersion1a = await UTIL.createAssetVersionTest({ idAsset: this.asset1.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion1a', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        this.assetVersion1b = await UTIL.createAssetVersionTest({ idAsset: this.asset1.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion1b', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        this.assetVersion1c = await UTIL.createAssetVersionTest({ idAsset: this.asset1.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion1c', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersionT3 = await UTIL.createAssetVersionTest({ idAsset: this.assetT3.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersionT3', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersion2 = await UTIL.createAssetVersionTest({ idAsset: this.asset2.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion2', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersion3 = await UTIL.createAssetVersionTest({ idAsset: this.asset3.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion3', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersion4 = await UTIL.createAssetVersionTest({ idAsset: this.asset4.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion4', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersionT5 = await UTIL.createAssetVersionTest({ idAsset: this.assetT5.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersionT5', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        ...
        this.assetVersion8a = await UTIL.createAssetVersionTest({ idAsset: this.asset8.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion8a', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        this.assetVersion8b = await UTIL.createAssetVersionTest({ idAsset: this.asset8.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion8b', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        this.assetVersion8c = await UTIL.createAssetVersionTest({ idAsset: this.asset8.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion8c', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });
        this.scene1 = await UTIL.createSceneTest({ Name: 'OA Test scene1', idAssetThumbnail: this.assetT5.idAsset, CountScene: 0, CountNode: 0, CountCamera: 0, CountLight: 0, CountModel: 0, CountMeta: 0, CountSetup: 0, CountTour: 0, EdanUUID: null, PosedAndQCd: true, ApprovedForPublication: true, idScene: 0 });
        ...
        this.assetVersion9 = await UTIL.createAssetVersionTest({ idAsset: this.asset9.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageHash: 'OA Test', StorageSize: BigInt(500), idAssetVersion: 0, Ingested: true, BulkIngest: false, FileName: 'OA Test assetVersion9', StorageKeyStaging: '', idSOAttachment: null, FilePath: '/OA Test', Version: 0 });

...
export class ObjectHierarchyTestSetup {
    ...
    async initialize(): Promise<void> {
        ...
        this.assetVersion1 = await UTIL.createAssetVersionTest({ idAsset: this.asset1.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion2 = await UTIL.createAssetVersionTest({ idAsset: this.asset2.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion3a = await UTIL.createAssetVersionTest({ idAsset: this.asset3.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        this.assetVersion3b = await UTIL.createAssetVersionTest({ idAsset: this.asset3.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        this.assetVersion3c = await UTIL.createAssetVersionTest({ idAsset: this.asset3.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion4 = await UTIL.createAssetVersionTest({ idAsset: this.asset4.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion5 = await UTIL.createAssetVersionTest({ idAsset: this.asset5.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion6 = await UTIL.createAssetVersionTest({ idAsset: this.asset6.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion7 = await UTIL.createAssetVersionTest({ idAsset: this.asset7.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion8 = await UTIL.createAssetVersionTest({ idAsset: this.asset8.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion9 = await UTIL.createAssetVersionTest({ idAsset: this.asset9.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });
        ...
        this.assetVersion10 = await UTIL.createAssetVersionTest({ idAsset: this.asset10.idAsset, idUserCreator: this.user1.idUser, DateCreated: UTIL.nowCleansed(), StorageChecksum: 'OA Test', StorageSize: 500, idAssetVersion: 0, Ingested: true, Version: 0 });

...
const modelTestCaseInspectJSONMap: Map<string, string> = new Map<string, string>([
    ...
    ['x3d',                 '{"success":true,"error":"","modelObjects":[],"modelMetrics":[],"modelMaterials":[{"idModelMaterial":1,"Name":""}],"modelMaterialChannels":[{"idModelMaterialChannel":1,"idModelMaterial":1,"idVMaterialType":64,"MaterialTypeOther":null,"idModelMaterialUVMap":1,"UVMapEmbedded":false,"ChannelPosition":0,"ChannelWidth":3,"Scalar1":null,"Scalar2":null,"Scalar3":null,"Scalar4":null,"AdditionalAttributes":null,"idVMaterialTypeOrig":64,"idModelMaterialUVMapOrig":1}],"modelObjectModelMaterialXref":null,"uvMaps":[[1,"eremotherium_laurillardi-150k-4096-diffuse.jpg"]]}'], // eslint-disable-line no-useless-escape
]);

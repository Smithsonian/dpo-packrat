...
describe('DB Fetch SystemObject Fetch Pair Test Suite', () => {
    ...
    test('DB Fetch SystemObject: DBObjectTypeToName', async () => {
        ...
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAccessAction)).toEqual('Access Action');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAccessContext)).toEqual('Access Context');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAccessContextObject)).toEqual('Access Context Object');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAccessPolicy)).toEqual('Access Policy');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAccessRole)).toEqual('Access Role');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAccessRoleAccessActionXref)).toEqual('Access Role Access Action Xref');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAssetGroup)).toEqual('Asset Group');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eAudit)).toEqual('Audit');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eCaptureDataFile)).toEqual('Capture Data File');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eCaptureDataGroup)).toEqual('Capture Data Group');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eCaptureDataGroupCaptureDataXref)).toEqual('Capture Data Group Capture Data Xref');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eCaptureDataPhoto)).toEqual('Capture Data Photo');
        ...
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eJobRun)).toEqual('Job Run');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eLicense)).toEqual('License');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eLicenseAssignment)).toEqual('License Assignment');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eMetadata)).toEqual('Metadata');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelMaterial)).toEqual('Model Material');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelMaterialChannel)).toEqual('Model Material Channel');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelMaterialUVMap)).toEqual('Model Material UV Map');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelObject)).toEqual('Model Object');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelObjectModelMaterialXref)).toEqual('Model Object Model Material Xref');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelProcessingAction)).toEqual('Model Processing Action');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelProcessingActionStep)).toEqual('Model Proessing Action Step');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eModelSceneXref)).toEqual('Model Scene Xref');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eSystemObject)).toEqual('System Object');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eSystemObjectVersion)).toEqual('System Object Version');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eSystemObjectXref)).toEqual('System Object Xref');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eUnitEdan)).toEqual('Unit Edan');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eUser)).toEqual('User');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eUserPersonalizationSystemObject)).toEqual('User Personalization System Object');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eUserPersonalizationUrl)).toEqual('User Personalization Url');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eVocabulary)).toEqual('Vocabulary');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eVocabularySet)).toEqual('Vocabulary Set');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eWorkflow)).toEqual('Workflow');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eWorkflowStep)).toEqual('Workflow Step');
        expect(DBAPI.DBObjectTypeToName(DBAPI.eNonSystemObjectType.eWorkflowStepSystemObjectXref)).toEqual('Workflow Step System Object Xref');

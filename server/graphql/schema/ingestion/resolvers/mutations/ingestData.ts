...
class IngestDataWorker extends ResolverBase {
    ...
    private async validateIdentifier(identifier: IngestIdentifierInput): Promise<IdentifierResults> {
        ...
        const regexArk: RegExp = new RegExp("ark:\/65665\/[0-9a-zA-Z-]*([^@!%$&#*+=.,\"\'\^]+$)");  /* eslint-disable-line */
        const regexEdan: RegExp = new RegExp("edanmdm\:[a-z]*[a-z|A-Z|0-9_.]*([^@!%$&#*=+\"\']+$)");/* eslint-disable-line */

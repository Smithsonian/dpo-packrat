    ...
    return (
        <Box className={classes.container}>
            ...
            <Box className={classes.formContainer}>
                ...
                <Typography variant='caption' style={{ display: 'block', fontSize: '0.8rem', color: '#666', marginBottom: '8px' }}>
                    Listed users gain access to this project regardless of unit membership.
                    When restricted, <b>only</b> listed users and admins can view this project.
                </Typography>
                    ...
                    {authorizedUsers.length > 0 ? (
                        ...
                        <Typography variant='caption' style={{ display: 'block', color: '#999', margin: '4px 0 8px' }}>
                            {isRestricted
                                ...
                                : 'No additional users. Access is determined by unit membership.'}
                        </Typography>
                    )}

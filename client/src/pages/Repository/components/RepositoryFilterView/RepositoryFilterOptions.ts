...
export const metadataToDisplayOptions: FilterOption[] = [
    ...
    { label: 'CD Volume Modality', value: eMetadata.eCDVolumeModality },
    { label: 'CD Volume Content Type', value: eMetadata.eCDVolumeContentType },
    { label: 'CD Volume Scan Type', value: eMetadata.eCDVolumeScanType },
    { label: 'CD Volume Specimen Preparation', value: eMetadata.eCDVolumeSpecimenPreparation },
...
export const defaultDisplayMetadataAndWidth = {
    ...
    [eMetadata.eCDVolumeModality]: { name: 'Capture Volume Modality', width: 130 },
    [eMetadata.eCDVolumeContentType]: { name: 'Capture Volume Content Type', width: 150 },
    [eMetadata.eCDVolumeScanType]: { name: 'Capture Volume Scan Type', width: 130 },
    [eMetadata.eCDVolumeSpecimenPreparation]: { name: 'Capture Volume Specimen Preparation', width: 170 },

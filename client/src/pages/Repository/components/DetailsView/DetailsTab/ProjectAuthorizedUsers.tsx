    ...
    return (
        <Box className={classes.container}>
            ...
            <Typography className={classes.description}>
                ...
                When restricted access is enabled, <b>only</b> listed users and admins can view this
                project and its contents. Changes take effect on each user&apos;s next login.
            </Typography>
